...
A `.docx` is read directly — the CLI extracts its template text before analyzing, so
`jinjutsu invoice.docx` works as-is. [examples/docx](../docx) walks that workflow end to end.
